...
latex_documents = [
    (master_doc, 'jeju.tex', u'jeju Documentation',
...
man_pages = [
    (master_doc, 'jeju', u'jeju Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jeju', u'jeju Documentation',
     author, 'jeju', 'One line description of project.',
     'Miscellaneous'),
]
